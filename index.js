...
// Adding Hours, Minutes, Seconds in Down 
window.addEventListener("DOMContentLoaded", (event) => {
  
  down(1, 12, setHours);
 
  down(0, 59, setMinutes);

  down(0, 59, setSeconds);
...
function down(start, end, element){
...
//function for alert and running
...
//function to check, Is alarms saved in Local Storage or not?
